...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			css: ".usi_display * {  font-size: 1em;  line-height: 1.2;  box-sizing: border-box;  color: inherit;  font-family: Roboto, Arial;}.usi_display {  color: #000;  font-family: Roboto, Arial;}.usi_header_text span {  font-family: inherit;  color: #000;  letter-spacing: -1px;}.usi_header_text2 span {  font-weight: bold;  font-family: inherit;  color: #000;  letter-spacing: -1px;}.usi_header_text {  position: absolute;  top: 20%;  left: 4%;  width: 45%;  height: 15%;  font-size: 1.53em;  color: #000;  text-align: center;}.usi_text_bottom {\tposition: absolute;  top: 35%;  left: 4%;  width: 45%;  height: 28%;  font-size: 3.2em;  color: #000;}.usi_header_text span {  text-align: center;}.usi_text_bottom span {\tfont-weight: bold;  text-align: center;}.usi_header_text.enabled { \tposition: absolute;\ttop: 28%;  left: 8%;  width: 43%;  height: 15%;  font-size: 0.8em;  color: #000;  text-align: left; }.usi_text_bottom.enabled {  position: absolute;  top: 38%;  left: 8%;  width: 43%;  height: 28%;  font-size: 2.7em;  color: #000;}.usi_header_text.enabled span {    text-align: left !important;}.usi_text_bottom.enabled span {    text-align: left !important;}.usi_header_text2 {  position: absolute;  top: 28%;  left: 9%;  width: 74%;  height: 33%;  color: #000;}.usi_bullet_container {  position: absolute;  display: block;  top: 42%;  left: 9%;  }.usi_bullet_text {  display: block;  font-size: 1.7em;  color: #000;  padding-bottom: 6px;  width: 100%;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {  background: none;  border: none;}.usi_submitbutton {  position: absolute;\ttop: 64.5%;  left: 9.5%;  width: 34%;  height: 13.5%;  display: inline-block;  background: none;  border: none;  margin: 0;  padding: 0;  cursor: pointer;  text-align: center;  color: #fff;  font-weight: bold;  font-size: 1.4em;}.usi_submitbutton.enabled {  top: 71.5%;  left: 7.5%;  width: 33%;  height: 13.5%;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
...
if(usi_app.is_enabled) {
  ...
  usi_js.display_vars.background = "/chatskins/5698/2025-06-rebrand-dsktp-pre-blank.webp";
}
...
var enabled_class = usi_app.is_enabled ? 'enabled' : ''

usi_js.display_vars.p1_html = [
  '<div class="usi_header_text ' ,enabled_class, '">',(usi_app.messaging.header1 || ""),'</div>',
  '<div class="usi_text_bottom ' ,enabled_class, '">',usi_app.messaging.header2,'</div>',
	'<button class="usi_submitbutton ' ,enabled_class, '" onclick="usi_js.click_cta();" type="button">',usi_app.messaging.cta,'</button>',
].join('');
